...
const translations = {
  ...
  "ru": {
    ...
    "hero.subtitle": "Мы храним ключи, проверяем квартиру, готовим её к приезду и отправляем понятные фотоотчёты — чтобы жильё в Аликанте было под контролем, пока вас нет.",
    ...
    "hero.trust2.title": "Хранение ключей",
    "hero.trust2.text": "свежая закупка под заказ",
    "hero.trust3.title": "Arrival ready",
    "hero.trust3.text": "до вашего приезда",
